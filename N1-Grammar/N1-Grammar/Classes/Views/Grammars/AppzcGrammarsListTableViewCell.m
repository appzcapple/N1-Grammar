...
@implementation AppzcGrammarsListTableViewCell
...
-(void)configCellInfo:(AppzcJpGrammar *)grammar{
    [self.grammarNamelbl setText:grammar.grammarStr];
    [self.usagelbl setText:grammar.usage];
    [self.translatelbl setText:grammar.translate];
}
